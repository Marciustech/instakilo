...
npx prisma generate --schema=./src/prisma/schema.prisma || throw_error "Failed to generate Prisma client"
npx prisma migrate deploy --schema=./src/prisma/schema.prisma || throw_error "Failed to deploy Prisma migrations"
